...
def train_q_learning(episodes=10, max_steps=500, alpha=0.1, gamma=0.99, epsilon=1.0, epsilon_decay=0.995, min_epsilon=0.01):
...
def train_monte_carlo(episodes=10, max_steps=500, gamma=0.99, epsilon=1.0, epsilon_decay=0.995, min_epsilon=0.01):
...
if __name__ == "__main__":
    ...
    q_table_ql, ang_vel_bins_ql, _ = train_q_learning(episodes=10, max_steps=100)
    ...
    q_table_mc, ang_vel_bins_mc, _ = train_monte_carlo(episodes=10, max_steps=100)
